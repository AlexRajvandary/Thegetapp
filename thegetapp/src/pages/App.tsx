...
const products = [
  ...
  const subscriptions = [
 {
  ...
  items={[
    ...
    <Banner key="5" title="Оплатим для вас покупку на любом сайте или в приложении!" imageSrc="/jpmoney.jpg" text="Оплачиваем товары, услуги и подписки в USD, EUR, GBP, CNY, JPY, INR и других валютах через PayPal или карты (Visa, Mastercard, AmEx).
